function varargout = op_D_DC_gradu_gradv_times_u_tp(spu, spv, spg, msh, u)
    ...
    for iel = 1:msh.nel_dir(1)
        ...
        [indices{iel}, values{iel}] = op_D_DC_gradu_gradv_times_u(sp1_col, sp2_col, sp3_col, msh_col, u);
    end

function varargout = op_D_DP_gradu_gradv_times_u_tp(space1, space2, space3, msh, dCdP, u)
    ...
    for iel = 1:msh.nel_dir(1)
        ...
        [rows{iel}, cols{iel}, vals{iel}] = op_D_DP_gradu_gradv_times_u(sp1_col, sp2_col, sp3_col, msh_col, dCdP, u);
    end

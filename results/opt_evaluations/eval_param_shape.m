...
opts.Phase0 = OptimizationHistory(end).Parameters(46).Value;
...
exportgraphics(ax,['plots/paramshapeOpt.pdf']) 
exportgraphics(ax,['plots/paramshapeOpt.png'], 'Resolution', 300) 
...
save("data/Torque_param_shape.mat", "angles", "T", "T1", "T2")

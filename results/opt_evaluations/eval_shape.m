...
folder = '../opt_shape/plots/final';
srfName = '/RotorOpt98.txt';
...
exportgraphics(ax,['plots/shapeOpt.pdf']) 
exportgraphics(ax,['plots/shapeOpt.png'], 'Resolution', 300) 
...
save("data/Torque_shape.mat", "angles", "T", "T1", "T2")

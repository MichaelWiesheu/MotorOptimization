...
MatMagnetRight = MAT_NdFeB_OPT(1, MA1, @(x)(pi/2-deg2rad(x/2)+pi/4), "MA");
MatMagnetLeft = MAT_NdFeB_OPT(1, MA2, @(x)(-pi/2+deg2rad(x/2)+pi/4), "MA");
...
Rotor.addOptimizationParameter("DMAG", 30e-3, 20e-3, 40e-3);
Rotor.addOptimizationParameter("DSLIT5", 1e-3, 0.5e-3, 6e-3);
Rotor.addOptimizationParameter("DSLIT6", 2e-3, 1.5e-3, 8e-3);
Rotor.addOptimizationParameter("LSLIT1", 6.4e-3, 1e-3, 8e-3);
Rotor.addOptimizationParameter("LSLIT2", 4.3e-3, 1e-3, 8e-3);
Rotor.addOptimizationParameter("MT1", 4e-3, 1.5e-3, 10e-3);
Rotor.addOptimizationParameter("MW1", 22e-3, 10e-3, 27e-3);
Rotor.addOptimizationParameter("MA", 150, 100, 160);
Rotor.addOptimizationParameter("RA1", 144, 130, 170);
Rotor.addOptimizationParameter("RA2", 166, 150, 179);
Rotor.addOptimizationParameter("RS", 1e-3, 1e-3, 4e-3);

Rotor.addOptimizationParameter("RW2", 1e-3, 5e-4, 4e-3);
Rotor.addOptimizationParameter("RW3", 1e-3, 5e-4, 4e-3);
Rotor.addOptimizationParameter("RW4", 1e-3, 5e-4, 2e-3);
Rotor.addOptimizationParameter("RW5", 1e-3, 5e-4, 2e-3);
Rotor.addOptimizationParameter("WMAG", 4e-3, 3e-3, 8e-3);
...
Motor.addOptimizationConstraint("TorqueMEAN", ">", 2.3/4, 100);
